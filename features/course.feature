Feature: Course instance maintains data about itself
  ...
  Scenario Outline: System asks for the course subject
    Given the course has subject <subject>
  ...
  Scenario Outline: System asks for the course number extension
    ...
    Examples:
      | subject | title                       | number | extension | year | term     | grade | active | result |
      | IT      | Networking                  | 221    |           | 2016 | Spring   | 92    | is not |        |
      | IT      | Intro to Databases and DBMS | 220    |           | 2016 | Fall     | 70    | is     |        |
      | CS      | Programming I               | 120    |           | 2015 | Fall     | 90    | is not |        |
      | CS      | Programming II              | 130    |           | 2016 | Spring   | 88    | is not |        |
      | CS      | Computer Organization       | 220    |           | 2016 | Spring   | 91    | is not |        |
  ...
  Scenario Outline: System asks if student is active in course
    ...
    Examples:
      | subject | title                       | number | extension | year | term     | grade | active | result |
      | IT      | Networking                  | 221    |           | 2016 | Spring   | 92    | is not | False  |
      | IT      | Intro to Databases and DBMS | 220    |           | 2016 | Fall     | 70    | is     | True   |
      | CS      | Programming I               | 120    |           | 2016 | Fall     | 90    | is     | True   |
      | CS      | Programming II              | 130    |           | 2016 | Spring   | 88    | is not | False  |
      | CS      | Computer Organization       | 220    |           | 2016 | Spring   | 91    | is not | False  |
